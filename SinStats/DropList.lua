...
local function SetEnabledCompat(widget, enabled)
	...
	if widget.SetEnabled then widget:SetEnabled(enabled)
	elseif enabled then if widget.Enable then widget:Enable() end
	else if widget.Disable then widget:Disable() end end
end
local L = Ns.L
