...
{ stat="Intellect", onupdate=true, events={}, spell=23030, spellclass="Spell", widget={ type="CheckBox" }, options={ Enhanced_Base=true, }, subgroup=true, activeonload=true, },
...
--{ stat="Valorstones", events={ CURRENCY_DISPLAY_UPDATE=true, }, currency=3008, spellclass="Currency", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true, activeonload=true },
...
{ stat="Memories", events={ CURRENCY_DISPLAY_UPDATE=true, }, currency=3089, spellclass="Currency", widget={ type="CheckBox" }, options={ Show=true, }, subgroup=true },
