...
-- Residual Memories
function Ns.FunctionList.Memories(HUD, data, options, ...)

	local memo = C_CurrencyInfo.GetCurrencyInfo(3089)
	local display = 0

	if memo.name and tonumber(memo.quantity) then display = memo.quantity
	else display = 0 end
...
function Ns.FunctionList.DreamSurge(HUD, data, options, ...)
	...
	local countTotal = C_Item.GetItemCount(207026, true)
...
function Ns.FunctionList.SparkDreams(HUD, data, options, ...)
	...
	local returnText
	local spark = C_Item.GetItemCount(Ns.Spark.Awake, true)
	local splinter = C_Item.GetItemCount(Ns.Spark.splAwake, true)
...
function Ns.FunctionList.Bullion(HUD, data, options, ...)
	...
	local bullion = C_Item.GetItemCount(213089, true)
...
function Ns.FunctionList.GigaSeed(HUD, data, options, ...)
	...
	local returnText
	local giga = C_Item.GetItemCount(Ns.Seeds.Gigantic, true)
	local plump = C_Item.GetItemCount(Ns.Seeds.Plump, true)
...
function Ns.FunctionList.PlumpSeed(HUD, data, options, ...)
	...
	local seed = C_Item.GetItemCount(Ns.Seeds.Plump, true)
...
function Ns.FunctionList.SeedBloom(HUD, data, options, ...)
	...
	local seed = C_Item.GetItemCount(Ns.Seeds.Bloom, true)
